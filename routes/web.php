...
Route::get('order/cancel', [invoiceController::class, 'cancelOrder'])->name('invoice.cancel');
...
Route::get('deliveryguy/delete', [deliveryController::class, 'fireDelivery'])->name('deliveryguy.delete');
